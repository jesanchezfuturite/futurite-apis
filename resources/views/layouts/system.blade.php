...
<html lang="en">
	...
	<head>
        ...
        <style>
        #confirmModal {
            z-index: 1060; /* Asegúrate de que sea mayor que el modal principal */
        }
        </style>
							...
							<div class="d-flex flex-grow-1 flex-lg-grow-0">
								...
								<div class="d-flex align-items-center me-7" id="kt_app_header_logo_wrapper">
									...
									<a href="index.html" class="d-flex align-items-center me-lg-20 me-5">
										<img alt="Logo" src="{{asset('assets/media/logos/demo-35-small.svg')}}" class="h-20px d-sm-none d-inline" />
										<img alt="Logo" src="{{asset('assets/media/logos/demo-35.svg')}}" class="h-20px h-lg-25px theme-light-show d-none d-sm-inline" />
										<img alt="Logo" src="{{asset('assets/media/logos/demo-35-dark.png')}}" class="h-20px h-lg-25px theme-dark-show d-none d-sm-inline" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Logo wrapper-->
									...
									<div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
										...
										<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link py-3" href="{{ url('ads/config') }}" title="Agregamos la configuración de las cuentas de nuestros clientes" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										...
										<a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #6441A5">
													<img src="{{asset('assets/media/svg/brand-logos/twitch-2.svg')}}" class="mw-25px" alt="" />
                                                    </span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/activity.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #E34984">
													<img src="{{asset('assets/media/svg/brand-logos/dribbble-2.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #00BF6D">
													<img src="{{asset('assets/media/svg/brand-logos/gab.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/followers.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #001935">
													<img src="{{asset('assets/media/svg/brand-logos/tumblr.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #E60000">
													<img src="{{asset('assets/media/svg/brand-logos/youtube-2.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/settings.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #0B66C3">
													<img src="{{asset('assets/media/svg/brand-logos/linkedin-3.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #2682ff">
													<img src="{{asset('assets/media/svg/brand-logos/eolic-energy.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/followers.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #cfe2ff">
													<img src="{{asset('assets/media/svg/brand-logos/vimeo.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
										...
										<a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
											...
											<div class="symbol symbol-35px symbol-lg-40px me-3">
												<span class="symbol-label rounded-4" style="background-color: #f1aeb5">
													<img src="{{asset('assets/media/svg/brand-logos/foursquare.svg')}}" class="mw-25px" alt="" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Info-->
